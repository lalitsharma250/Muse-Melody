package com.example.musemelody.player
...
import com.example.musemelody.notification.LocalNotificationHelper
    ...
    private fun notification() {
        ...
        try {
            val source = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.P) {
                ImageDecoder.createSource(contentResolver, song.getImageUri())
            } else {
